...
class BaseRenderer:
    ...
    commands: Enum = None
    commands_to_text: Dict[commands, str] = None
...
class MenuRenderer(BaseRenderer):
    ...
    def render_button(self, command: commands, text: str) -> types.InlineKeyboardButton:
...
class ListRenderer(BaseRenderer):
    ...
    def __call__(self, list_data: List[ListRenderingInfo], *args, **kwargs) -> types.InlineKeyboardMarkup:
