...
class ProjectMenuRenderer(MenuRenderer):
    ...
    commands_with_permissions_to_text: Dict[Tuple[commands, Tuple], str] = {
        (
            ProjectMenuCommands.LIST_USERS,
            (UserRoles.ADMIN.value, UserRoles.CREATOR.value, UserRoles.USER.value),
        ): "List users",
        (
            ProjectMenuCommands.LIST_TAGS,
            (UserRoles.ADMIN.value, UserRoles.CREATOR.value, UserRoles.USER.value),
        ): "List tags",
        (
            ProjectMenuCommands.TRANSACTIONS,
            (UserRoles.ADMIN.value, UserRoles.CREATOR.value, UserRoles.USER.value),
        ): "Transactions",
