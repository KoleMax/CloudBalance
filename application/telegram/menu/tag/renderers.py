...
class TagMenuRenderer(MenuRenderer):
    ...
    def __init__(
        self, user_id: int, user_role_id: int, project_id: int, project_name: str, tag_id: int, tag_name: str
    ):
...
RETURN_CALLBACK_DATA = CallbackData(
    "back_to_tag_menu", "user_id", "project_id", "project_name", "tag_id", "tag_name", "command"
)
